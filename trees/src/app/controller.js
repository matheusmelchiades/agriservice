...
module.exports.post = async (request, response) => {
    ...
    try {
        ...
        if (err instanceof mongoose.Error) {
            return response.status(500).json({ error: 'Error to create a tree' })
        }
...
module.exports.get = async (request, response) => {
    ...
    try {
        ...
        if (err instanceof mongoose.Error) {
            return response.status(500).json({ error: 'Error to get trees' })
        }
...
module.exports.put = async (request, response) => {
    ...
    try {
        ...
        if (err instanceof mongoose.Error) {
            return response.status(500).json({ error: 'Error to update tree' })
        }
...
module.exports.delete = async (request, response) => {
    ...
    try {
        ...
        if (err instanceof mongoose.Error) {
            return response.status(500).json({ error: 'Error to delete a tree' })
        }
